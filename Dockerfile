...
# Most packages commented out for faster debugging
...
# Firefox ESR - commented out for faster debugging
...
# Make Firefox the default browser - commented out since Firefox is commented out
# RUN update-alternatives --set x-www-browser /usr/bin/firefox-esr

# ----------------------------------------------------------
# KDE Plasma Desktop - commented out for faster debugging
...
# ----------------------------------------------------------
# VNC Server - commented out for faster debugging
...
RUN groupadd -g 1000 ubuntu && \
  ...
  usermod -a -G adm,audio,cdrom,dialout,dip,sudo,video ubuntu && \
...
# ------------------------------------------------------------------------------
# User Applications & Utilities - most commented out for faster debugging
